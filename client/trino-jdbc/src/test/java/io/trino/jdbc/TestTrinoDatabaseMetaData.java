        ...
        try (Connection connection = createConnectionWithNullCatalogMeansCurrent()) {
            ...
            assertMetadataCalls(
                    ...
                    ImmutableMultiset.<String>builder()
                            ...
                            .addCopies("ConnectorMetadata.getSystemView(schema=test_schema1, table=test_table1)", 20)
                            ...
                            .addCopies("ConnectorMetadata.getSystemView(schema=test_schema2, table=test_table1)", 20)
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            assertMetadataCalls(
                    ...
                    ImmutableMultiset.<String>builder()
                            ...
                            .addCopies("ConnectorMetadata.getSystemView(schema=test_schema1, table=test_table_)", 4)
