    ...
    public void testMetadataCalls()
    {
        ...
        assertMetadataCalls(
                ...
                ImmutableMultiset.<String>builder()
                        ...
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema2, table=test_table1)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema3_empty, table=test_table1)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema4_empty, table=test_table1)", 4)
        ...
        assertMetadataCalls(
                ...
                ImmutableMultiset.<String>builder()
                        ...
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema1, table=test_table1)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema1, table=test_table2)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema2, table=test_table1)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema2, table=test_table2)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema3_empty, table=test_table1)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema3_empty, table=test_table2)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema4_empty, table=test_table1)", 4)
                        .addCopies("ConnectorMetadata.getSystemView(schema=test_schema4_empty, table=test_table2)", 4)
                        .add("ConnectorMetadata.getMaterializedView(schema=test_schema1, table=test_table1)")
                        ...
                        .add("ConnectorMetadata.getMaterializedView(schema=test_schema4_empty, table=test_table1)")
                        .add("ConnectorMetadata.isView(schema=test_schema1, table=test_table1)")
                        .add("ConnectorMetadata.isView(schema=test_schema1, table=test_table2)")
                        .add("ConnectorMetadata.isView(schema=test_schema2, table=test_table1)")
                        .add("ConnectorMetadata.isView(schema=test_schema2, table=test_table2)")
                        .add("ConnectorMetadata.isView(schema=test_schema3_empty, table=test_table1)")
